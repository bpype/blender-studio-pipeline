...
def copy_transfer_data_ownership(
        td_type_key: str,
        target_obj: Object,
        transfer_data_dict: dict
    ) -> None:
    """Copy Transferable Data item to object if no entry exists

    Args:
        td_type_key: Type of ownership data to transfer.
        transfer_data_item: Item of CollectionProperty from source object
        target_obj (Object): Object to add Transferable Data item to
    """
    obj_ownership_data = target_obj.transfer_data_ownership
...
def transfer_data_clean_all(obj: Object):
...
def init_transfer_data(
    ...
    Args:
        obj (Object): Target object for Transferable Data
...
def apply_transfer_data(context: Context, transfer_data_map: dict[Object, dict]) -> None:
    ...
    Args:
        ...
        transfer_data_map: Map generated by the AssetTransferMapping class
    """
