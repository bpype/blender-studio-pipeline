...
- #### widgets/widgets.py
Implements loading widgets, either from the Widgets.blend file, or a file provided by the user via the preferences, or the currently opened .blend file.

- #### bone_gizmos.py
[Bone Gizmos](https://projects.blender.org/studio/blender-studio-tools/src/branch/main/docs/addons/bone_gizmos.md) is an experimental/abandoned add-on of mine, and this module allows components to interface with it.
...
- **external_components**: Example code of how you can [implement your own components](#adding-a-new-component-parameter), showing both an ultra-minimal case, and one showing off some of CloudRig's features.
...
- **component_list**: The "Component List" sub-panel in the Properties->Armature->CloudRig panel.
- **component_param_panels**: The parameter sub-panels in the Properties->Bone editor.
- **rig_component_ui**: The parameter main panel in the Properties->Bone editor.
- **menu_3dview**: The "CloudRig" editor header menu in armature pose/edit mode.
